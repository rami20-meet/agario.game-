...
my_ball = Ball(0,0,10,15,22, (random.randint(0,225), random.randint(0,225), random.randint(0,225)))
...
while running == True :
    ...
    if my_ball.r >= 150 :
        running = False
        turtle.write("YOU WIN", move=False, align="center", font=("Arial", 100 , "normal"))
